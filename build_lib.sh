...
cmake -Wno-dev \
      -DCMAKE_PREFIX_PATH="/tools/package/boost/1.55.0;/tools/package/hdf5/1.10.0-patch1;/tools/package/glew/2.0.0;/tools/package/openimageio/1.7.14_nobin;/tools/package/tbb/4.4.6;/tools/package/openexr/2.2.0;/tools/package/ilmbase/2.2.0;/tools/package/alembic/1.7.7_gcc4.8.5;/tools/package/opensubdiv/3.1.1;/tools/package/libjpeg/9b;/tools/package/libpng/1.6.29;/tools/package/tiff/4.0.6" \
      -DCMAKE_INSTALL_PREFIX='/dd/shows/DEVSGTK/user/work.gverma/git/AL_USD_build' \
